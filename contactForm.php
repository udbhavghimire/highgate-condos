...
$mail->Host = 'mail.highgatecondo.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@highgatecondo.ca'; // SMTP username
$mail->Password = 'highgatecondo'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@highgatecondo.ca', $_POST['name']);
...
$mail->Subject = "Highgate Condos Calgary - Landing Page Inquiry";
$message = '<html>
