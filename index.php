...
<head>
    ...
    <meta property="og:image" content="https://highgatecondo.ca/highgate_condos.jpg">
    <meta property="og:site_name" content="Highgate Condos" />
        ...
        <nav class="navbar navbar-expand-md navbar-light" id="navbar">
            <div class="container">
                <a href="/" class="navbar-brand">
                    <img src="./images/truman-highgate-logo.svg.svg" class="navbar-brand" alt="Highgate Condos logo">
                </a>
            ...
            <path d="M0 12H18V10H0V12ZM0 7H18V5H0V7ZM0 0V2H18V0H0Z" fill="black" />
                ...
                <div class="row me-0 row-cols-2 collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  Home
                            ...
                            <li class="nav-item px-md-2">
                                <a class="nav-link scrollto" href="#gallery">Rendering</a>
                            </li>
                            <!-- <li class="nav-item px-md-2">
    ...
    <div class="main">
                    ...
                    <div class="col order-2 order-md-1 pt-5 pt-md-0">
                      ...
                      Condos
                                ...
                                <div class="pt-2 pt-sm-2 pt-md-2 rounded-mine mt-3 ">
                                  ...
                                  <span class="fw-bold">Highgate Condos</span>, a pre construction condoproject by Truman, is an upcoming condominium development in Calgary. It's located at 8 Ave NE and Range Rd 285, on the eastern side of Calgary. This residential community boasts a beautifully designed 13-acre green space, featuring parks and trails. The project is anticipated to be finished by 2028.
                                ...
                                <p class="mybot pb-md-0 pb-0 ">
                                    Address:  8 Ave NE and Range Rd 285, Calgary, AB
                                </p>
                                <p class="mybot pb-md-0 pb-0 ">
                                Occupancy: 2028
                                </p>
        ...
        <div class="pt-md-5 pt-5"  data-aos="fade-up" >
                ...
                <div class="d-flex justify-content-center text-center textt">
                    ...
                    <p class="mybot pb-md-0 pb-0 ">
                            <span class="fw-bold">Developer:</span> Truman.
                        </p>
                        <p class="mybot pb-md-0 pb-0 ">
                            <span class="fw-bold">Address:</span> 8 Ave NE and Range Rd 285, Calgary, ON
                        </p>

                        <p class="mybot pb-md-0 pb-0 ">
                            <span class="fw-bold"> Pricing: </span>Starting from the $350's!
                        </p>
                        <p class="mybot pb-md-0 pb-0 ">
                            <span class="fw-bold">  Expected Completion: </span> 2028
                        </p>
                        <p class="mybot pb-md-0 pb-0 ">
                            <span class="fw-bold"> Size: </span> 480 - 1000 SQ.FT.
                        </p>
                        ...
                        <p class="mybot pb-md-0 pb-0 ">
                            <span class="fw-bold"> Number of Units:</span> 272
                        </p>
    ...
    <section id="gallery">
            <div class="container">
                ...
                <div class="pt-md-5 pt-5">
                    <h2 class="fw-bold fs-1 pb-2  ps-3 ps-md-0 d-flex justify-content-center custom-underline brand-color">
                        Highgate Condos - Coming Soon to Huxley
                    </h2>
                    <div>
                        <section>
                                ...
                                <div class="d-flex justify-content-center align-items-center pb-3">
                                    ...
                                    <img src="./images/Highgate-Condos-Rendering.png" class="img-fluid bg-img" alt="">
        ...
        <!-- <section class="pt-md-5 pt-2" id="features">
            <div class="container pt-md-2">
                ...
                <h2 class="fw-bold fs-1 pb-2 text-center justify-content-center py-md-2 py-5 mt-2 mt-md-0 custom-underline brand-color">
                    Amenities</span>
                </h2>
                <div>
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 justify-content-center g-4 ">
                        <div class="col">
                            <div href="#" class="afte">
                                <img src="images/a1.jpg" alt="Historic Landmark" class="img-fluid rounded-mine imghei">
                                <div class="img-text">
                                    <p class="mb-0">Historic Landmark</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="afte">
                                <img src="images/a2.jpg" alt="Local Dining" class="img-fluid rounded-mine imghei">
                                <div class="img-text">
                                    <p class="mb-0">Local Dining</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="afte">
                                <img src="images/a3.jpg" alt="Outdoor Adventure" class="img-fluid rounded-mine imghei">
                                <div class="img-text">
                                    <p class="mb-0">Outdoor Adventure</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div href="#" class="afte">
                                <img src="images/a4.jpg" alt="Cultural Experience" class="img-fluid rounded-mine imghei">
                                <div class="img-text">
                                    <p class="mb-0">Cultural Experience</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div href="#" class="afte">
                                <img src="images/a5.jpg" alt="Natural Landscapes" class="img-fluid rounded-mine imghei">
                                <div class="img-text">
                                    <p class="mb-0">Natural Landscapes</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="pt-5 mt-5">
                    <div class="row mx-0 ">
                        ...
                        <div class="registertext px-4 d-flex justify-content-center align-items-center  text-center">
                            <p>Register today to get the more information on Highgate Condos coming up in Calgary 
                            </p>
                        </div>
        ...
        <footer class="footerr  py-5 mb-4">
            <div class="container ">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5 justify-content-between ">
                    ...
                    <div class="col-md-2 mt-md-5 pt-md-5 mt-sm-0 pt-4 center-sm d-flex  justify-content-center">
                        <img src="images/turman-logo.png" class="img-fluid regoimg mx-3" alt="Truman-logo">
